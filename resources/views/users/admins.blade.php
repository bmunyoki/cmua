...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Administators</li>
    </ol>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> Administrators
                        </div>
                        <div class="card-body">
                            @if(Auth::user()->role == 2)
                            <div class="add-buttons">
                                <button type="button" class="btn btn-primary add-buttons" data-toggle="modal" data-target=".bd-example-modal-lg"> + Admin</button>
                            </div>
                            @endif
                            <table class="table table-responsive-sm">
                                ...
                                <tbody class="users">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $admin->phone }}</td>
                                        <td>{{ $admin->phone }}</td>
                                        <td><?php echo date( 'd F Y', strtotime($admin->created_at)); ?></td>
                                        <td>
                                            <a href="#" class="editUser" data-code="{{ $admin->id }}" title="Edit" data-toggle="modal" data-target=".bd-example-modal-lg-edit"><i class="fa fa-edit" style="color: #20a8d8;"></i></a>
                                        </td>
                                        <td>
                                            <a href="#" class="deleteUser" data-code="{{ $admin->id }}" title="Delete"><i class="fa fa-trash" style="color: red;"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="addAdmin">Save</button>
                </div>
            </div>
        </div>
    </div>
